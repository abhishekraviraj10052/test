...
<div class="container mt-5">
  ...
  <div class="">
    <h2>Users</h2>
    <a href="{{route('user_manage',['admin_id'=>$admin_id])}}" class="mx-4">Create New User</a>
    <a href="{{route('user_details')}}" class="mx-4">Back</a>
  </div>
  <table class="table table-bordered text-center">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{'Active'}}</td>
        @endif
        <td><a href="{{route('user_manage',['id'=>$user->id,'admin_id'=>$user->admin_id])}}">Edit</a></td>
